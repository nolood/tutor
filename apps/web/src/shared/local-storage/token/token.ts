...
export class TokenApi<T> extends LocalStorage<T> {
  ...
  public removeToken(): void {
    ...
    this.deleteValue(EStorageKey.REFRESH_TOKEN);
  }
}
export const tokenApi = <T>(schema: ZodSchema<T>) => new TokenApi(schema);
